...
Результатом завдання буде посилання на збережений у репозиторії вихідний код файлів Makefile та Dockerfile.До вас звернувся колега QA з проханням допомогти у підготовці коду до тестування на різних платформах.
...
Я був би вдячний, якщо ви можете допомогти мені з цим завданням. Якщо у вас є будь-які запитання або потрібні додаткові відомості, будь ласка, дайте мені знати, перед тим подивись документацію: https://docs.docker.com/build/building/multi-platform/#cross-compilation*. Таску в jira, якщо треба, я заведу.
...
Dockerfile: базовий образ quay.io/projectquay/golang

Makefile: image - білд для платформи/архітектури хоста на якому виконується команда, clean повинен містити видалення новоствореного образу docker rmi <IMAGE_TAG>

*використовувати стандартний docker build згідно документації наданій в листі, без buildx

https://github.com/Slavasly/kbot