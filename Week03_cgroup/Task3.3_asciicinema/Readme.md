...
Рекомендуємо створити аккаунт в asciinema для збереження скрінкастів, інакше скрінкасти зникнуть через декілька днів і будуть недоступними для перевірки ментором курсу.

Приклад посилання https://asciinema.org/a/583009

Ваша відповідь
Отриманий URL: https://asciinema.org/a/XTAyTci5cH8LZYEH